...
public class MyConvenientBanner<T> extends LinearLayout {
    ...
    private void init(Context context) {
        View hView = LayoutInflater.from(context).inflate(
                R.layout.home_banner_layout, this, true);
     ...
     * @return
     */
    public MyConvenientBanner setPageTransformer(ViewPager.PageTransformer transformer) {
     ...
     * @return
     */
    public MyConvenientBanner setOnPageChangeListener(ViewPager.OnPageChangeListener onPageChangeListener) {
